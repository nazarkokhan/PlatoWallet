...
public record Hub88GetRoundRequest(
    [property: DefaultValue("test")] string Environment,
    Hub88GetRoundGameApiRequest ApiRequest) : IRequest<IResult>
{
    public class Handler : IRequestHandler<Hub88GetRoundRequest, IResult>
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var response = await _gameApiClient.GetGameRoundAsync(
                environment.BaseUrl,
