...
public record Hub88GetPrepaidsListRequest(
    [property: DefaultValue("test")] string Environment,
    Hub88GetPrepaidsListGameApiRequest ApiRequest) : IRequest<IResult>
{
    public class Handler : IRequestHandler<Hub88GetPrepaidsListRequest, IResult>
    {
        ...
        public async Task<IResult> Handle(
            Hub88GetPrepaidsListRequest request,
            CancellationToken cancellationToken)
        {
            ...
            var response = await _gameApiClient.GetPrepaidsListAsync(
                environment.BaseUrl,
