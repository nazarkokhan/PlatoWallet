...
namespace Platipus.Wallet.Infrastructure.Migrations
{
    ...
    [Migration("20221005071209_NumbersScaleConstraint")]
    partial class NumbersScaleConstraint
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Platipus.Wallet.Domain.Entities.ErrorMock", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Platipus.Wallet.Domain.Entities.ErrorMock", b =>
                {
                    b.HasOne("Platipus.Wallet.Domain.Entities.Session", "Session")
                        .WithOne("ErrorMock")
                        .HasForeignKey("Platipus.Wallet.Domain.Entities.ErrorMock", "SessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
